...
namespace Wraith {
	...
	void ImGuiLayer::OnAttach() {
		...
		io.Fonts->AddFontFromFileTTF("assets/fonts/roboto/static/Roboto-Bold.ttf", 16.0f);
		io.FontDefault = io.Fonts->AddFontFromFileTTF("assets/fonts/roboto/Roboto-VariableFont_wdth,wght.ttf", 16.0f);
