...
- the next step is editor polish and platform packaging depth: improve package UX further, add richer validation/reporting where needed, and eventually graduate from the plain staged macOS executable layout to more polished distribution targets
